...
"""
function gaussianprob_bandwidth{G <: Real}(distances::Array{G, 1}, ordinals::Array{Int64, 1}, nparticles::Integer; paccept::Float64 = 0.5)
    maxdist = maxdist_bandwidth(distances, ordinals, Int(nparticles / 2))
    return maxdist / sqrt(-2.0 * log(paccept))
end

function gaussianprob_bandwidth{G <: Real}(distances::Array{G, 2}, ordinals::Array{Int64, 1}, nparticles::Integer; paccept::Float64 = 0.5)
    maxdist = maxdist_bandwidth(distances, ordinals, Int(nparticles / 2))
